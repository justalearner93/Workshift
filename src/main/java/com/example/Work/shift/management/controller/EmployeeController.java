package com.example.Work.shift.management.controller;
...
public class EmployeeController {
		...
		public String updateEmployee(@PathVariable Long id,
			...
			existingEmployee.setShiftType(employee.getShiftType());
			existingEmployee.setShiftHour(employee.getShiftHour());
		...
		//handler method to handle method delete
